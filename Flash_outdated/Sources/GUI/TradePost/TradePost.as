...
function onLoad()
{
	...
	m_Window.SignalHelp.Connect(HelpButtonHandler, this);
}
...
//Help Button Handler
function HelpButtonHandler():Void
{
	var selectedTab:Number = m_Window.GetContent().GetSelectedIndex();
	switch(selectedTab)
	{
		case 0:	LoreBase.OpenTag(5137);
				break;
		case 1:	LoreBase.OpenTag(6358);
				break;
		case 2: LoreBase.OpenTag(5138);
				break;
	}
}