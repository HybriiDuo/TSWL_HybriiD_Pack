...
//Class
class GUI.TradePost.Views.TimeCash extends MovieClip
{
    //Properties
    ...
    private function Init():Void
    {
        ...
        if (m_Character != undefined)
        {
            ...
            var cash:Number = m_Character.GetTokens(_global.Enums.Token.e_Gold_Bullion_Token);
    ...
    {
        if (id == _global.Enums.Token.e_Gold_Bullion_Token)
        {
