...
import GUI.ChallengeJournal.ChallengeJournalContent;
...
function onLoad()
{
	...
	var windowTitle:String = LDBFormat.LDBGetText("GenericGUI", "ChallengeJournalTitle");
	
	m_Window.SetTitle(windowTitle, "left");
	m_Window.SetPadding(10);
	m_Window.SetContent("ChallengeJournalContent");
...
{
	DistributedValue.SetDValue("challengeJournal_window", false);
}