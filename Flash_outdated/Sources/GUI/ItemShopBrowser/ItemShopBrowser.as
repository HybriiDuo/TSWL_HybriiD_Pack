...
function onLoad()
{
    ...
    var windowTitle:String = LDBFormat.LDBGetText("GenericGUI", "Item_Shop");
    
    m_Window.SetTitle(windowTitle, "left");
    m_Window.SetPadding(10);
    m_Window.SetContent("ItemShopBrowserContent");
...
{
    DistributedValue.SetDValue("itemshop_window", false);
}