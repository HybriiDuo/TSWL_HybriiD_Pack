...
class GUI.SkillHiveSimple.BoostClip extends UIComponent
{
	...
	private function UpdateFilter()
	{
		if (m_FeatData.m_Trained)
		{
			...
			com.Utils.Colors.Tint(m_Ability, 0xE99DE5, 100);
			this._parent.m_Tile.m_Circle.m_BG._visible = true;
		}
		else
		{
			...
			{
				m_Ability._alpha = 30;
				com.Utils.Colors.Tint(m_Ability, 0x000000, 30);
				this._parent.m_Tile.m_Circle.m_BG._visible = false;
			}
		}
	}
