...
function onLoad()
{
    ...
    var windowTitle:String = LDBFormat.LDBGetText("GenericGUI", "LeaderboardsTitle");
    
    m_Window.SetTitle(windowTitle, "left");
    m_Window.SetPadding(10);
    m_Window.SetContent("LeaderboardsBrowserContent");
...
function CloseWindowHandler():Void
{
    ...
    DistributedValue.SetDValue("leaderboards_browser", false);
}