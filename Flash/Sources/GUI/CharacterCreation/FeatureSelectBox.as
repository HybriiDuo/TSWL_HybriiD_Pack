...
dynamic class GUI.CharacterCreation.FeatureSelectBox extends UIComponent
{  
	//PROPERTIES
	...
	//STATICS
	private var NUM_FEATURES:Number = 7;
	...
	private function FillFeatureButtons()
	{
		for (var i:Number = 0; i < NUM_FEATURES; i++)
		{
			...
			featureButton.m_Label.text = LDBFormat.LDBGetText("CharCreationGUI", "FeatureSlot_" + i);
		}
	}
	
	private function SetLabels()
	{
		m_Header.text = LDBFormat.LDBGetText("CharCreationGUI", "FeatureSelector_BoxHeader");
	}
