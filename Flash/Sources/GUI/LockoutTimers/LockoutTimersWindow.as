...
function onLoad()
{
	...
	var windowTitle:String = LDBFormat.LDBGetText("GenericGUI", "LockoutTimersTitle");
	
	m_Window.SetTitle(windowTitle, "left");
	m_Window.SetPadding(10);
	m_Window.SetContent("LockoutTimersContent");
...
{
	m_Window.m_Content.mItemList.dataProvider = [];
	DistributedValue.SetDValue("lockoutTimers_window", false);
}